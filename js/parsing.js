...
//=====================================================================
Parsing.Parse_ReduceWhitespace =
	function Parse_ReduceWhitespace(Text)
	{
		if (Text === null)
		{
			return '';
		...
		var text_line_count = 0;
		var empty_line_count = 0;
		var output = '';
		for (var index = 0; index < text_lines.length; index++)
		{
			var text_line = text_lines[index];
